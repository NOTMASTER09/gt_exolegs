...
public class GTExoLegsItems {
    ...
    public static ItemEntry<ItemExoskeletonLegs> LV_EXOSKELETON_LEGS = REGISTRATE
            .item("lv_exoskeleton_legs", p -> ItemExoskeletonLegs.create(p, GTValues.LV))
            .lang("LV Exoskeleton Legs")
            .register();

    @SuppressWarnings("unused")
    public static ItemEntry<ItemExoskeletonLegs> MV_EXOSKELETON_LEGS = REGISTRATE
    ...
    @SuppressWarnings("unused")
    public static ItemEntry<ItemExoskeletonLegs> HV_EXOSKELETON_LEGS = REGISTRATE
    ...
    @SuppressWarnings("unused")
    public static ItemEntry<ItemExoskeletonLegs> EV_EXOSKELETON_LEGS = REGISTRATE
    ...
    @SuppressWarnings("unused")
    public static ItemEntry<ItemExoskeletonLegs> IV_EXOSKELETON_LEGS = REGISTRATE
